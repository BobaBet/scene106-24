...
const transform3 = new Transform({
  position: new Vector3(6.043886184692383, 16.629878997802734, 9.307377815246582),
  rotation: new Quaternion(0.3341425955295563, 0.11686918139457703, -0.25725293159484863, 0.8991725444793701),
  scale: new Vector3(2, 2.0000011920928955, 2.0000016689300537)
})
...
const transform4 = new Transform({
  position: new Vector3(6.845959186553955, 16.906383514404297, 8.175908088684082),
  rotation: new Quaternion(-0.41817978024482727, -0.7184500694274902, -0.05436910688877106, -0.5531720519065857),
  scale: new Vector3(2.000004768371582, 2.000002384185791, 2.0000081062316895)
})
...
const transform5 = new Transform({
  position: new Vector3(5.967380523681641, 17.951946258544922, 7.808617115020752),
  rotation: new Quaternion(-0.25725293159484863, -0.8991726040840149, -0.3341424763202667, 0.11686920374631882),
  scale: new Vector3(2.000009059906006, 1.9999994039535522, 2.0000057220458984)
})
...
const transform6 = new Transform({
  position: new Vector3(5.165307998657227, 17.675439834594727, 8.940086364746094),
  rotation: new Quaternion(-0.05436918884515762, 0.5531720519065857, 0.41817963123321533, -0.718450129032135),
  scale: new Vector3(2.000014066696167, 2.000000238418579, 2.000011444091797)
})
imageFromURL4.addComponentOrReplace(transform6)

const imageFromURL5 = new Entity('imageFromURL5')
engine.addEntity(imageFromURL5)
imageFromURL5.setParent(_scene)
const transform7 = new Transform({
  position: new Vector3(7.125349521636963, 17.918556213378906, 10.388925552368164),
  rotation: new Quaternion(-0.399536669254303, 0.2645442485809326, -0.09926620125770569, 0.8720855116844177),
  scale: new Vector3(1.999999761581421, 2.000004529953003, 2.000004291534424)
})
...
const transform8 = new Transform({
  position: new Vector3(6.043886184692383, 16.629878997802734, 9.307377815246582),
  rotation: new Quaternion(-0.09926620125770569, -0.8720855116844177, 0.399536669254303, 0.2645442485809326),
  scale: new Vector3(2.000009059906006, 2.0000040531158447, 2.000009536743164)
})
...
const gltfShape2 = new GLTFShape("models/Plant_02/Plant_02.glb")
...
const transform10 = new Transform({
  position: new Vector3(15.237137794494629, 0, 14.935623168945312),
  rotation: new Quaternion(-1.1059513315930347e-15, -0.5555702447891235, 6.622912707143769e-8, 0.8314695954322815),
  scale: new Vector3(0.999999463558197, 1, 0.999999463558197)
})
balsamFlower2.addComponentOrReplace(transform10)
balsamFlower2.addComponentOrReplace(gltfShape2)
...
script1.spawn(imageFromURL, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL, channelBus))
script1.spawn(imageFromURL2, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL2, channelBus))
script1.spawn(imageFromURL3, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL3, channelBus))
script1.spawn(imageFromURL4, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL4, channelBus))
script1.spawn(imageFromURL5, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL5, channelBus))
script1.spawn(imageFromURL6, {"image":"https://gateway.pinata.cloud/ipfs/QmWZPszneBjpVdAaSXqJD3E4WCmEoxt3RhRnjjRCVLfird"}, createChannel(channelId, imageFromURL6, channelBus))